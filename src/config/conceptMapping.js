const toolsPage_conceptMapping =  {
  ...
  child_mortality_0_5_year_olds_dying_per_1000_born:
    {concept: "child_mortality_0_5_year_olds_dying_per_1000_born", source: "fasttrack"},
  child_mortality_0_5_year_olds_more_years_version_7:
    {concept: "child_mortality_0_5_year_olds_dying_per_1000_born", source: "fasttrack"},
  gapminder_gini:
    {concept: "gini", source: "fasttrack"},
  ...
  population_total:
    { concept: "pop", source: "fasttrack" },
  life_expectancy_years:
    { concept: "lex", source: "fasttrack" },
  income_per_person_gdppercapita_ppp_inflation_adjusted:
    { concept: "gdp_pcap", source: "fasttrack" },
  ...
  electricity_use_total:
    { concept: "electricity_use_per_person" },
  // removed by World Bank from WDI
  energy_use_total:
    { concept: "energy_use_per_person" },
  ...
  female_salaried_workers_percent_of_female_labour_force:
    { concept: "female_salaried_workers_percent_of_non_agricultural_female_employment" },
  ...
  hourly_compensation_us:
    { concept: "hourly_labour_cost_constant_2011_usd" },
  ...
  male_salaried_workers_percent_of_male_labour_force:
    { concept: "male_salaried_workers_percent_of_non_agricultural_male_employment" },
