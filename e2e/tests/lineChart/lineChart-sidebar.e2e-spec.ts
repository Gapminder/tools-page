...
describe('Line chart: Sidebar', () => {
    ...
    it('Show selected countries on the sidebar', async () => {
         ...
         */
        const chartCountriesText = await chartCountries.getAttribute('innerText');
        const modalCountriesText = await modalCountries.getAttribute('innerText');
