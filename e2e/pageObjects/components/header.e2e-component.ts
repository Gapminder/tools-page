...
export class Header {
  ...
  rootSelector: ExtendedElementFinder = this.isDesktop ? _$('.header') : _$('.header.open');
  /**
   * Social buttons
   */

  social: ExtendedElementFinder = this.rootSelector._$('.social');
  ...
  howToModal: ExtendedElementFinder = this.rootSelector._$('.how-to-content');
