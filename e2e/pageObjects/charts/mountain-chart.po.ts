...
export class MountainChart extends CommonChartPage {
    ...
    public selectedCountriesOnChart: ElementArrayFinder = $$('path[class="vzb-mc-mountain vzb-mc-aggrlevel0 vzb-selected"]');
    ...
    public rightSidePanelSelectedCountriesList: ElementArrayFinder = $$('.vzb-find-list > .vzb-checked');
